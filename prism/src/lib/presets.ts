...
export const PRESETS: Preset[] = [
  ...
  },
  {
    id: 'hap-alpha',
    label: 'HAP Alpha',
    hint: 'HAP mit Alphakanal für Overlays und Keying auf dem Medienserver. Ohne Ton — ein Overlay bringt seinen eigenen selten mit.',
    group: 'pro',
    family: 'video',
    icon: 'Blend',
